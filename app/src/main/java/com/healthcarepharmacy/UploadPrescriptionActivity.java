...
public class UploadPrescriptionActivity extends AppCompatActivity {
    ...
    ImageButton galleryBtn,pastRxBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  FirebaseApp.initializeApp(this);
        ...
        galleryBtn = findViewById(R.id.Upload_prescription_layout_imgGalleryBtn);
        pastRxBtn = findViewById(R.id.Upload_prescription_layout_pastBtn);

        txt = findViewById(R.id.Upload_prescription_layout_txt_guide1);

        nextBtn = findViewById(R.id.Upload_prescription_layout_UploadBtn);
        ...
        galleryBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //get selected image from selected sourse
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (getPickImageResultUri(data) != null) {
                ...
                try {
                    ...
                    imgSamplePre.setImageBitmap(myBitmap);
