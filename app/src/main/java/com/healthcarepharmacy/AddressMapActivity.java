...
public class AddressMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Places.initialize(AddressMapActivity.this, getString(R.string.google_maps_api));
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        task.addOnSuccessListener(AddressMapActivity.this, new OnSuccessListener<LocationSettingsResponse>() {
            @Override
        ...
        task.addOnFailureListener(AddressMapActivity.this, new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                if (e instanceof ResolvableApiException) {
                    ResolvableApiException resolvable = (ResolvableApiException) e;
                    try {
                        resolvable.startResolutionForResult(AddressMapActivity.this, 51);
